...
app.get('/', function (req, res) {
	res.send('Hola, soy un bot construido con Nodejs y API.AI, me encuentro alojado en Heroku y puedes hablar conmigo a través de facebook messenger')
})
	...
	switch (action) {
		 case "detailed-application":
		 	if(isDefined(contexts[0]) && contexts[0].name == 'job_application' && contexts[0].parameters){
		 		let phone_number = (isDefined(contexts[0].parameters['phone_number']) 
				...
				if(phone_number != '' && user_name != '' && previous_job != '' && years_of_experience != '' && job_vacancy != ''){   //if(phone_number != '' && user_name != '' && previous_job != '' && years_of_experience != '' && job_vacancy != '')
					let emailContent = 'Una nueva solicitud de trabajo de: ' + user_name + 'para la vacante: ' + job_vacancy + 
						'.<br> Previous job position: '+ previous_job + '.' + 
						'.<br> Years of experience: '+ years_of_experience + '.' +
						'.<br> Phone number: '+ phone_number + '.';

					sendEmail('Nueva postulación', emailContent);
				}
		 	}
